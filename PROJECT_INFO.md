# House of Venus - Project Overview
...
| Table | Purpose |
|-------|---------|
| `products` | 12 products with images, prices, Venus signs |
| `collections` | 5 themed collections |
| `lookbooks` | 4 editorial lookbooks |
| `blog_posts` | 4 articles with content |
...
- **ZodiacIcon**: SVG icons for all 12 zodiac signs
